...
import AdvanceRegisterTable from "./advance-register-table";
import { getAdvanceRegeReport } from "./advance-register-api";
...
export default function AdvanceRegisterPage() {
  ...
  const loadData = async () => {
    const res = await getAdvanceRegeReport();
    setData(res);
    setFiltered(res);
  };
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-semibold">Advance Register</h1>
      ...
      {/* TABLE */}
      <AdvanceRegisterTable data={filtered} />
