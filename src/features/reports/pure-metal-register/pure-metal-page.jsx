...
import PureMetalTable from "./pure-metal-table";
import { getPureMetalReport } from "./pure-metal-api";

export default function PureMetalPage() {
  ...
  const loadData = async () => {
    const res = await getPureMetalReport();
    setData(res);
    setFiltered(res);
  };
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-semibold">Pure Metal Register</h1>
